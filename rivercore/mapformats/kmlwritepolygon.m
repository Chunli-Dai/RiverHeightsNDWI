...
%          label for the polygon. If the vertex list contains multiple
%          outer rings, a folder is created with the value of Name and each
%          outer ring is labeled 'Part N' where N varies from 1 to the
%          number of outer rings. The default value is 'Polygon 1'.
%
%     Description
%          A string which specifies the contents to be displayed in the
%          polygon's description tag(s). The description appears in the
%          description balloon when the user clicks on either the feature
%          name in the Google Earth Places panel or clicks the polygon in
%          the viewer window.
%
...
%
%     FaceColor
%          A MATLAB Color Specification (ColorSpec) (string, scalar
