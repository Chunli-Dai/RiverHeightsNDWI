...
%          numeric vector with values between 0 and 1) that specifies the
%          color of the line. If the value is a cell array, it is scalar.
%          If the value is a numeric vector, it is size 1-by-3. The value
%          'none' indicates that a color value is not included in the file.
%          If unspecified, a value is not included in the file and the
%          color of the line is determined by the viewer.
%
%     Alpha
