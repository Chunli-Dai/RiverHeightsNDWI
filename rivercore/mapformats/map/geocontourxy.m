...
%       pass in a string that names your spheroid. Instead, pass that
%       string to referenceEllipsoid or referenceSphere and use the
%       resulting object.) The WGS 84 reference ellipsoid is used by
%       default.
%
%   Output Arguments
%   ----------------
