...
%   specified by the coordinateSystemType string. The value 'geographic'
%   results in a geographic cells reference object appropriate to a
%   latitude-longitude system. The value 'planar' results in a map cells
%   reference object appropriate to a projected map coordinate system.
%   This optional input is helpful in the absence of a projection file.
%   (The function throws an error if a projection file is present and
%   coordinateSystemType contradicts the type of coordinate reference
%   system defined in the projection file.)
%
%   Example
%   -------
...
%
%   See also GEOTIFFREAD, SDTSDEMREAD, WORLDFILEREAD
