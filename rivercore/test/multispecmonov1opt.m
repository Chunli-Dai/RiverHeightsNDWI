...
Med=imdilate(isnan(NDWI),ones(widthriv*3/resrc)); %image edge
...
badflag=0;badflag2=-1;sigma0hat=[0.5, 0.5];%default
...
fprintf(fid,' %f %f %f %f %f %d %f %f %d (NDWI mean std thres) %s \n',mean1,std1,mean2,std2,ithreshold,badflag,sigma0hat,badflag2,stripmetafile);
fclose(fid);
